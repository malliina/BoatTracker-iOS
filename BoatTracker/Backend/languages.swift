...
struct SettingsLang: Codable {
    let welcome, welcomeText, laterText, notifications, notificationsText, howItWorks, signIn, signInText, boat, token, tokenText, tokenTextLong, rename, renameBoat, newName, edit, cancel, back, noTracksHelp: String
